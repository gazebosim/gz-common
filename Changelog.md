...
1. graphics: Optimize Texture Processing and Memory in AssimpLoader
    * [Pull request #767](https://github.com/gazebosim/gz-common/pull/767)

1. packages.apt: use jetty package names
    * [Pull request #693](https://github.com/gazebosim/gz-common/pull/693)
...
1. Fix `NaN` result in `Animation::Time()` for zero-length animations
    * [Pull request #745](https://github.com/gazebosim/gz-common/pull/745)
