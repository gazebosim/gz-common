...
1. Port Skeleton fixes from gazebo.
    * [Pull request 206](https://bitbucket.org/osrf/gazebo/pull-request/206)

1. Port gazebo9 fix for ColladaLoader with multiple geometries
    * [Pull request 208](https://bitbucket.org/osrf/gazebo/pull-request/208)

1. `SystemPaths::FindSharedLibrary`: return input if its is an absolute path to a file
    * [Pull request 209](https://bitbucket.org/osrf/gazebo/pull-request/209)
