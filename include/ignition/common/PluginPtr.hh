...
namespace ignition
{
  namespace common
  {
    ...
    class TemplatePluginPtr final
    {
      ...
      public: GZ_DEPRECATED(5) TemplatePluginPtr();
      ...
      public: GZ_DEPRECATED(5) TemplatePluginPtr(TemplatePluginPtr &&_other);
      ...
      public: template <typename OtherPluginType>
              GZ_DEPRECATED(5) TemplatePluginPtr(
      ...
      /// empty PluginPtr.
      private: explicit GZ_DEPRECATED(5) TemplatePluginPtr(
