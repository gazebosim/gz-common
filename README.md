...
Build | Status
-- | --
Test coverage | [![codecov](https://codecov.io/gh/gazebosim/gz-common/branch/ign-common4/graph/badge.svg)](https://codecov.io/gh/gazebosim/gz-common/branch/ign-common4)
...
Windows       | [![Build Status](https://build.osrfoundation.org/buildStatus/icon?job=ign_common-ign-4-win)](https://build.osrfoundation.org/job/ign_common-ign-4-win)
...
Please refer to the [examples directory](https://github.com/gazebosim/gz-common/tree/ign-common4/examples).
