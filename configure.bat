...
cmake -G "NMake Makefiles"^
    ...
    -DSWSCALE_INCLUDE_DIRS=%FFMPEG_INCLUDE_DIR%^
    -DSWSCALE_LIBRARY_DIRS=%FFMPEG_LIBRARY_DIR%^
    -DSWSCALE_LIBRARIES=swscale^
    -DAVFORMAT_INCLUDE_DIRS=%FFMPEG_INCLUDE_DIR%^
    -DAVFORMAT_LIBRARY_DIRS=%FFMPEG_LIBRARY_DIR%^
    -DAVFORMAT_LIBRARIES=avformat^
    -DAVCODEC_INCLUDE_DIRS=%FFMPEG_INCLUDE_DIR%^
    -DAVCODEC_LIBRARY_DIRS=%FFMPEG_LIBRARY_DIR%^
    -DAVCODEC_LIBRARIES=avcodec^
    -DAVUTIL_INCLUDE_DIRS=%FFMPEG_INCLUDE_DIR%^
    -DAVUTIL_LIBRARY_DIRS=%FFMPEG_LIBRARY_DIR%^
